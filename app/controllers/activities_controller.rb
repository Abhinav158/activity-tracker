# The code below is automatically generated by Rails
...
class ActivitiesController < ApplicationController
  ...
  def index
    # @ signifies an Instance Variable - Available on controller and the view
    # Fetch all the records and store them inside activities
